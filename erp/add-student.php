                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1" class="form-label">Fullname <sup class="star" style='color: red;'>*</sup></label>
                                                        <input name="fullname" type="text" class="form-control" placeholder="Enter Fullname Name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="mname" type="text" class="form-control" placeholder="Enter Mother's Name">
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="mcc" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true" required>
                                                    ...
                                                    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input name="mno" type="number" class="form-control" placeholder="Enter Mobile Number" min="99999" max="9999999999" required>
                                                                                        </div>
                                                                                        </div>
                                                                                        </div>
                                                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="mano" type="number" class="form-control" min="99999" max="9999999999" placeholder="Enter Alternate Mobile Number">
                                            </div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="wano" type="number" class="form-control" min="99999" max="9999999999" placeholder="Enter WhatsApp Number" >
                                            </div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="aadharno" type="text" class="form-control aadharno" placeholder="Enter Aadhar Card / VID Number"  >
                                            </div>
                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="admdate" type="date" class="form-control" placeholder="Enter Admission Date" >
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="rollnostatus" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true" >
                                                    <option value="0" selected>Choose Status</option>
                                                    <option value="1">Roll Number Received</option>
                                                    <option value="2">Pending from University</option>
                                                    <option value="3">LGS Verified</option>
                                                    <option value="4">LGS Not Verified</option>
                                                    <option value="5">IBOSE</option>
                                                    <option value="6">Below 5000</option>
                                          ...
                                          <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="feecomm" class='form-control feecomm' value='20000' >
                                            </div>
                                            </div>
                                            ...
                                            <script>
                                                function sendForm(e=0) {
                                                    ...
                                                    for (let i = 0; i < 22; i++) {
                                                        ...
                                                        if(name=="mno" || name=="fullname" || name=="counsellor" || name=="batch" ) {
                                                            if(val==="" || val.length==0) {
                                                                swal({
                                                                    title: "Oops!",
                                                                    text: "Operation terminated since details were missing! Please fill all the required fields.",
                                                                    type: "warning",
                                                ...
                                                function savenext() {
                                                    ...
                                                    if( document.querySelector("input[name='feecomm']").value==0 ) {
                                                        swal({
                                                            title: "Oops!",
                                                            text: "Please add Fee Commitment before proceeding to next form! Or you can directly add a student.",
                                                            type: "warning",
                                                            showCancelButton: false
                                                        });
                                                        return 0;
                                                    ...
                                                    let prom = new Promise(function(succ, rej) {
                                                        let resp = sendForm("1");
                                                        if(resp==1 || resp=="phoneErr") {  rej(resp);  } else { succ(resp); }
                                                    });

                                                    prom.then(function(val) {
                                                        let resp = JSON.parse(atob(val));
                                                        $(".studid")[0].value = resp.studid;
                                                        $(".fllname")[0].value = resp.fullname;
                                                        ...
                                                        if(val=='phoneErr') {
                                                            swal({
                                                                title: "Oops!",
                                                                text: "A student with same phone number already exists! Try changing the phone  number.",
                                                                type: "warning",
                                                                showCancelButton: false
                                                            });
                                                        }
                                        ...
                                        <div class="tab-pane tab21" id="" role="tabpanel">
                                            ...
                                            <input type="hidden" name="fllname" class='fllname'>
                                ...
                                xhttp.onreadystatechange = function() {
                                    if (this.readyState == 4 && this.status == 200) {
                                        ...
                                        if(resp=='referr') {
                                            swal({
                                                title: "Oops!",
                                                text: "A Payment with this Referance no. already exists!",
                                                type: "warning",
                                                confirmButtonText: 'Ok'
                                            });
                                            return ;
                                        ...
                                        swal('Hooray!', 'Instalment added successfully!', 'success');
                                                        ...
                                                        input.onchange = function() {
                                                            ...
                                                            xhttp.onreadystatechange = function() {
                                                                if (this.readyState == 4 && this.status == 200) {
                                                                    ...
                                                                    let r = resp.status;
                                                                    $(e)[0].offsetParent.nextElementSibling.innerHTML = "<a href='./accdocs/"+resp.name+"' download='"+$(".fllname")[0].value+"-doc-"+$(".studid")[0].value+"'><span class='badge bg-success-transparent rounded-pill text-success p-2 px-3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i></span></a>";
