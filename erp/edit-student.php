    ...
    <div class="page">
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <img src='' alt="This type of file cannot be previewed." style='max-width: 700px;height: auto;'>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php if($_SESSION['usertype']=="0") { ?>
                                    <ul class="tabs-menu nav" role="tablist">
                                        ...
                                        <li><a href="#tab22" data-bs-toggle="tab" class="" aria-selected="false" tabindex="-1" role="tab"><i class="fa fe fe-database"></i>  Documents </a></li>
                                        <li><a href="#tab23" data-bs-toggle="tab" class="" aria-selected="false" tabindex="-1" role="tab"><i class="fa fe fe-truck"></i>  Result and Dispatch</a></li>
                                        ...
                                        <?php }else if($_SESSION['usertype']=="3") { ?>
                                            <!-- <li><a href="#tab22" data-bs-toggle="tab" class="active" aria-selected="true" tabindex="-1" role="tab"><i class="fa fe fe-database"></i>  Documents </a></li> -->
                                        <?php }else if($_SESSION['usertype']=="4") { ?>
                                            <!-- <li><a href="#tab23" data-bs-toggle="tab" class="active" aria-selected="true" tabindex="-1" role="tab"><i class="fa fe fe-truck"></i>  Result and Dispatch</a></li> -->
                                        <?php }else { ?>
                                            <script>
                                                swal({
                                                    title: "Oops!",
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="regstatus" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true">
                                                    <option value="0" <?php echo ($pdata["regstatus"]=="0") ? "selected" : ""; ?>>Choose Status</option>
                                                    <option value="1" <?php echo ($pdata["regstatus"]=="1") ? "selected" : ""; ?>>Not Eligible</option>
                                                    <option value="2" <?php echo ($pdata["regstatus"]=="2") ? "selected" : ""; ?>>Pending</option>
                                                    <option value="3" <?php echo ($pdata["regstatus"]=="3") ? "selected" : ""; ?>>Done</option>
                                                </select>
                                            </div>
                                            </div>
                                            <div class="col-6">
                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="rollnostatus" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true">
                                                    <option value="0" <?php echo ($pdata["rollstatus"]=="0") ? "selected" : ""; ?>>Choose Status</option>
                                                    <option value="1" <?php echo ($pdata["rollstatus"]=="1") ? "selected" : ""; ?>>Roll Number Received</option>
                                                    <option value="2" <?php echo ($pdata["rollstatus"]=="2") ? "selected" : ""; ?>>Pending from University</option>
                                                    <option value="3" <?php echo ($pdata["rollstatus"]=="3") ? "selected" : ""; ?>>LGS Verified</option>
                                                    <option value="4" <?php echo ($pdata["rollstatus"]=="4") ? "selected" : ""; ?>>LGS Not Verified</option>
                                                    <option value="5" <?php echo ($pdata["rollstatus"]=="5") ? "selected" : ""; ?>>IBOSE</option>
                                                    <option value="6" <?php echo ($pdata["rollstatus"]=="6") ? "selected" : ""; ?>>Below 5000</option>
                                                    <option value="7" <?php echo ($pdata["rollstatus"]=="7") ? "selected" : ""; ?>>Cancelled</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="lastname" type="text" class="form-control" placeholder="Enter Last Name" value='<?php echo  $pdata["name"]; ?>'  required>      
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                xhttp.onreadystatechange = function() {
                                    if (this.readyState == 4 && this.status == 200) {
                                        ...
                                        if(resp=='referr') {
                                            swal({
                                                title: "Oops!",
                                                text: "Payment with this Referance no. already exists!",
                                                type: "warning",
                                                confirmButtonText: 'Ok'
                                            });
                                            return ;
        ...
        <!-- Add Payment modal END -->
                                            ...
                                            <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                                ...
                                                <tbody class='insttable'>
                                                    ...
                                                    foreach ($insts as $key => $value) {
                                                        if($value['status']=="1") {
                                                            $status = '<span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><abbr style="text-decoration: none;" title="Approved from accounts department | Approved by '.$value['apby'].'">Approved</abbr></span>';
                                                            ...
                                                            $status = '<span class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3"><abbr style="text-decoration: none;" title="Reajected by accounts department | Rejected by '.$value['apby'].'">Rejected</abbr></span>';
                                                        }
                                                        if($value["file"]!="-") {
                                                            $html .= "<tr><td>".($key+1)."</td><td>".$status."</td><td>₹".$value['amount']."</td><td>".$value['date']."</td><td><a href='./accdocs/".$value['file']."' download><span class='badge bg-success-transparent rounded-pill text-success p-2 px-3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i></span></a></td><td>".$value['bankname']."</td><td>".$value['refno']."</td><td>".$value['note']."</td></tr>";
                                                        }else {
                                                            $html .= "<tr><td>".($key+1)."</td><td>".$status."</td><td>₹".$value['amount']."</td><td>".$value['date']."</td><td>NO</td><td>".$value['bankname']."</td><td>".$value['refno']."</td><td>".$value['note']."</td></tr>";
                                                        }
                                                    }
                                                    echo $html;
                                                    }
                                    ...
                                    <!-- <p>• Hover on the payment status to know more.</p> -->
                                        <div class="table-responsive">
                                            <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                                                ...
                                                <script>
                                                    function uploadDoc(e, t, m=0, eve=0) {
                                                        let input = "";
                                                        if(eve==0) {
                                                            ...
                                                            input.onchange = function() {
                                                                ...
                                                                xhttp.onreadystatechange = function() {
                                                                    if (this.readyState == 4 && this.status == 200) {
                                                                        ...
                                                                        if(r=="1") {
                                                                            ...
                                                                            // $(e)[0].offsetParent.nextElementSibling.innerHTML = "<a href='./accdocs/"+resp.name+"' download='<?php echo $fullname; ?>-doc-<?php echo $studid; ?>'><span class='badge bg-success-transparent rounded-pill text-success p-2 px-3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i></span></a>";
                                                                            if(eve!=0) {
                                                                                $(e)[0].offsetParent.offsetParent.children[0].className = "badge bg-success-transparent rounded-pill text-success p-2 px-3";
                                                                                $(e)[0].offsetParent.offsetParent.children[0].innerHTML = "Uploaded";
                                                                                $(e)[0].offsetParent.offsetParent.nextElementSibling.innerHTML = "<a href='./accdocs/"+resp.name+"' download='<?php echo $fullname; ?>-doc-<?php echo $studid; ?>'><span class='badge bg-success-transparent rounded-pill text-success p-2 px-3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i></span></a>";
                                                                                e.value = "";
                                                                            }
                                                                            else {
                                                                                $(e)[0].offsetParent.children[0].className = "badge bg-success-transparent rounded-pill text-success p-2 px-3";
                                                                                $(e)[0].offsetParent.children[0].innerHTML = "Uploadedb";
                                                                                $(e)[0].offsetParent.nextElementSibling.innerHTML = "<a href='./accdocs/"+resp.name+"' download='<?php echo $fullname; ?>-doc-<?php echo $studid; ?>'><span class='badge bg-success-transparent rounded-pill text-success p-2 px-3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i></span></a>";
                                                                            }
                                                                            swal({
                                                                                title: "Hooray!",
                                                                            ...
                                                                            swal({
                                                                                title: "Oops!",
                                                                                text: "Document addition was unsuccessful! Please contact admin of the website.",
                                                                                type: "warning",
                                                                                showCancelButton: false,
                                                                                confirmButtonText: 'Ok'
                                                                            });
                                                                ...
                                                                let fd = new FormData();
                                                                if(m==1) {
                                                                    for (let l = 0; l < Object.keys(input.files).length; l++) {
                                                                        let e = input.files[l];
                                                                        fd.set('file'+l, e);
                                                                    }
                                                                }
                                                    ...
                                                    function prevPhoto(path, type) {
                                                        $("#modaldemo8 img").attr('src', path);
                                                    }
                                                </script>
                                                <tbody>
                                                    <?php 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style='position:relative;'>
                                                            <span style='cursor:pointer' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">  Click to Upload</span>
                                                            <div class="dragupload" onclick='uploadDoc(this, 0);' style='width: 80%;height: 100%;z-index: 10;position:absolute;bottom:0;'>
                                                                <input type='file' onchange='uploadDoc(this, 0, 0, event);' style='width: 100%;height: 100%;opacity: 0;position:absolute;top:0;' onclick="return false;">
                                                            </div>
                                                        </td> 
                                                        <td>NA</td>
                                                        <?php    
                                                            ...
                                                            <td style='position: relative;'>
                                                                <span id='uploadDocSpan' class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='position:relative'>                                                                
                                                                Uploaded
                                                                </span>
                                                                <div class="dragupload" onclick='uploadDoc(this, 0);' style='width: 80%;height: 100%;z-index: 10;position:absolute;bottom:0;'>
                                                                    <input type='file' onchange='uploadDoc(this, 0, 0, event);' style='width: 100%;height: 100%;opacity: 0;position:absolute;top:0;' onclick="return false;">
                                                            ...
                                                            <td class='' style=''>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                    <a download="<?php echo $fullname; ?>-10thdoc-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["0"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                                    </div>
                                                                    
                                                                    <div class="col-3">
                                                                    <!-- <span class="mdi mdi-eye-circle-outline""></span> -->
                                                                    <!-- <a class="modal-effect btn btn-primary-light d-grid mb-3">Scale</a> -->
                                                                    <?php $mime = explode('/', mime_content_type('./accdocs/'.$docs['0']))[0]; ?> 
                                                                    <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='cursor: pointer;' data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modaldemo8" onclick="prevPhoto('./accdocs/<?php echo $docs['0']; ?>', '<?php echo $mime; ?>');"> <i style='font-size: 13px;' class="fa fa-eye" aria-hidden="true"></i></span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style='position:relative;'>
                                                            <span style='cursor:pointer' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">  Click to Upload</span>
                                                            <div class="dragupload" onclick='uploadDoc(this, 1);' style='width: 80%;height: 100%;z-index: 10;position:absolute;bottom:0;'>
                                                                <input type='file' onchange='uploadDoc(this, 1, 0, event);' style='width: 100%;height: 100%;opacity: 0;position:absolute;top:0;' onclick="return false;">
                                                            </div>
                                                        </td> 
                                                        <td>NA</td>
                                                        <?php    
                                                            ...
                                                            <td class='' style=''>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                    <a download="<?php echo $fullname; ?>-10thdoc-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["1"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                                    </div>
                                                                    
                                                                    <div class="col-3">
                                                                    <!-- <span class="mdi mdi-eye-circle-outline""></span> -->
                                                                    <!-- <a class="modal-effect btn btn-primary-light d-grid mb-3">Scale</a> -->
                                                                    <?php $mime = explode('/', mime_content_type('./accdocs/'.$docs['1']))[0]; ?> 
                                                                    <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='cursor: pointer;' data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modaldemo8" onclick="prevPhoto('./accdocs/<?php echo $docs['1']; ?>', '<?php echo $mime; ?>');"> <i style='font-size: 13px;' class="fa fa-eye" aria-hidden="true"></i></span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style='position:relative;'>
                                                            <span style='cursor:pointer' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">  Click to Upload</span>
                                                            <div class="dragupload" onclick='uploadDoc(this, 2);' style='width: 80%;height: 100%;z-index: 10;position:absolute;bottom:0;'>
                                                                <input type='file' onchange='uploadDoc(this, 2, 0, event);' style='width: 100%;height: 100%;opacity: 0;position:absolute;top:0;' onclick="return false;">
                                                            </div>
                                                        </td> 
                                                        <td>NA</td>
                                                        <?php    
                                                            ...
                                                            <td class='' style=''>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                    <a download="<?php echo $fullname; ?>-10thdoc-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["2"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                                    </div>
                                                                    
                                                                    <div class="col-3">
                                                                    <!-- <span class="mdi mdi-eye-circle-outline""></span> -->
                                                                    <!-- <a class="modal-effect btn btn-primary-light d-grid mb-3">Scale</a> -->
                                                                    <?php $mime = explode('/', mime_content_type('./accdocs/'.$docs["2"]))[0]; ?> 
                                                                    <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='cursor: pointer;' data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modaldemo8" onclick="prevPhoto('./accdocs/<?php echo $docs['2']; ?>', '<?php echo $mime; ?>');"> <i style='font-size: 13px;' class="fa fa-eye" aria-hidden="true"></i></span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td style='position:relative;'>
                                                            <span style='cursor:pointer' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">  Click to Upload</span>
                                                            <div class="dragupload" onclick='uploadDoc(this, 3);' style='width: 80%;height: 100%;z-index: 10;position:absolute;bottom:0;'>
                                                                <input type='file' onchange='uploadDoc(this, 3, 0, event);' style='width: 100%;height: 100%;opacity: 0;position:absolute;top:0;' onclick="return false;">
                                                            </div>
                                                        </td> 
                                                        <td>NA</td>
                                                        <?php    
                                                            ...
                                                            <td class='' style=''>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                    <a download="<?php echo $fullname; ?>-10thdoc-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["3"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                                    </div>
                                                                    
                                                                    <div class="col-3">
                                                                    <!-- <span class="mdi mdi-eye-circle-outline""></span> -->
                                                                    <!-- <a class="modal-effect btn btn-primary-light d-grid mb-3">Scale</a> -->
                                                                    <?php $mime = explode('/', mime_content_type('./accdocs/'.$docs['3']))[0]; ?> 
                                                                    <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='cursor: pointer;' data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modaldemo8" onclick="prevPhoto('./accdocs/<?php echo $docs['3']; ?>', '<?php echo $mime; ?>');"> <i style='font-size: 13px;' class="fa fa-eye" aria-hidden="true"></i></span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                        <td>5</td>
                                                        <td>University Fee Receipt</td>
                                                       
                                                        <?php if($docs[6]=="-") {
                                                        ?> 
                                                        <td style='position:relative;'>
                                                            <span style='cursor:pointer' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">  Click to Upload</span>
                                                            <div class="dragupload" onclick='uploadDoc(this, 6);' style='width: 80%;height: 100%;z-index: 10;position:absolute;bottom:0;'>
                                                                <input type='file' onchange='uploadDoc(this, 6, 0, event);' style='width: 100%;height: 100%;opacity: 0;position:absolute;top:0;' onclick="return false;">
                                                            </div>
                                                        </td> 
                                                        <td>NA</td>
                                                        <?php    
                                                            ...
                                                            <td class='' style=''>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3">
                                                                    <a download="<?php echo $fullname; ?>-10thdoc-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["6"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                                    </div>
                                                                    
                                                                    <div class="col-3">
                                                                    <!-- <span class="mdi mdi-eye-circle-outline""></span> -->
                                                                    <!-- <a class="modal-effect btn btn-primary-light d-grid mb-3">Scale</a> -->
                                                                    <?php $mime = explode('/', mime_content_type('./accdocs/'.$docs['6']))[0]; ?> 
                                                                    <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='cursor: pointer;' data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modaldemo8" onclick="prevPhoto('./accdocs/<?php echo $docs['6']; ?>', '<?php echo $mime; ?>');"> <i style='font-size: 13px;' class="fa fa-eye" aria-hidden="true"></i></span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <?php if(count($docs)>8) { $p=1; for ($i=8; $i < count($docs); $i++) {  ?>
                                                        <tr>
                                                            <td><?php echo $p+5; ?></td>
                                                            <td>Other Doc <?php echo $p; ?></td>
                                                        
                                                                <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" onclick='uploadDoc(this, <?php echo $i; ?>);'>Uploaded</span></td> 
                                                                <!-- <td></td> -->
                                                                ...
                                                                <td class='' style=''>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-3">
                                                                        <a download="<?php echo $fullname; ?>-otherdoc-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs[$i]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                                        </div>
                                                                        
                                                                        <div class="col-3">
                                                                        <!-- <span class="mdi mdi-eye-circle-outline""></span> -->
                                                                        <!-- <a class="modal-effect btn btn-primary-light d-grid mb-3">Scale</a> -->
                                                                        <?php $mime = explode('/', mime_content_type('./accdocs/'.$docs[$i]))[0]; ?> 
                                                                        <span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" style='cursor: pointer;' data-bs-effect="effect-scale" data-bs-toggle="modal" href="#modaldemo8" onclick="prevPhoto('./accdocs/<?php echo $docs[$i]; ?>', '<?php echo $mime; ?>');"> <i style='font-size: 13px;' class="fa fa-eye" aria-hidden="true"></i></span>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <tr>
                                                        <td>-</td>
                                                        <td><b>ADD MORE DOCS (MULTIPLE ALLOWED)</b></td>
                                                       
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 6, 1);' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    </tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content country-select-modal">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Dispatch | <?php echo $pdata['name']; ?></h6><button aria-label="Close" class="btn-close closeDispModal"
                            data-bs-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
                            ...
                            function saveDisp() {
                                ...
                                xhttp.onreadystatechange = function() {
                                    if (this.readyState == 4 && this.status == 200) {
                                        ...
                                        table.row.add([resp['count'],resp['date'],dtype,resp['trackid'],resp['remarks']]).draw(false);
        ...
        <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form class='resform'>
                                            <div class="form-group">
                                                <b><label for="resdet">Result Status</label></b>
                                                <?php $resStat = $pdata["resultStat"]; ?>
                                                <div class="row">
                                                    <div class="col-10">
                                                        <select name="resdet" id="" class="form-control">
                                                            <option value="0" <?php echo ($resStat=="0") ? "selected" : ""; ?>>Choose Option</option>
                                                            <option value="1" <?php echo ($resStat=="1") ? "selected" : ""; ?>>Pass</option>
                                                            <option value="2" <?php echo ($resStat=="2") ? "selected" : ""; ?>>Not Clear</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-2">
                                                        <button class="btn btn-primary" onclick="updateResult();return false;" type="button">Update Result</button>
                                                    </div>
                                                    <script>
                                                        function updateResult() {
                                                            ...
                                                            xml.onreadystatechange = function() {
                                                                if(this.status==200 && this.readyState==4) {
                                                                    ...
                                                                    if(resp!="1") {
                                                                        swal({
                                                                            title: "Oops!",
                                                                            text: "Updation was unsuccessful! Please contact administrator",
                                                                            type: "warning",
                                                                            showCancelButton: false
                                                                        });
                                                                    }
                                                                        ...
                                                                        swal({
                                                                            title: "Hooray!",
                                                                            text: "Result updation was successfull",
                                                                            type: "success",
                                                                            showCancelButton: false
                                                                        });
                                                                    }
                                                            ...
                                                            let fd = new FormData();
                                                            fd.append('res', document.querySelector('select[name="resdet"]').value);
                                                            fd.append('studid', '<?php echo $_GET["sid"]; ?>');
                                                            xml.open("POST", "../assets/backend/updateResult.php");
                                                            xml.send(fd);
                                                        }
                                                    </script>
                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php    
                                                            ...
                                                            ?> 
                                                            <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" onclick='uploadDoc(this, 4);'>Uploaded</span></td> 
                                                            <td><a download="<?php echo $fullname; ?>-DMC-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["4"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                        ...
                                                        <?php    
                                                            ...
                                                            ?> 
                                                            <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" onclick='uploadDoc(this, 5);'>Uploaded</span></td> 
                                                            <td><a download="<?php echo $fullname; ?>-diploma-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["5"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
                                                        ...
                                                        <?php if($docs[7]=="-") {
                                                        ?> 
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 7);' class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                        <?php    
                                                        }else {
                                                            ?> 
                                                            <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3" onclick='uploadDoc(this, 7);'>Uploaded</span></td> 
                                                            <td><a download="<?php echo $fullname; ?>-address-<?php echo $studid; ?>" href='./accdocs/<?php echo $docs["7"]; ?>'><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></a>
