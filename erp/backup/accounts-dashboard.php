                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        foreach ($studRes as $key => $value) {
                                                            ...
                                                            <td><button id="bEdit" onclick='window.location = "./edit-student?sid=<?php echo $value["studid"]; ?>"' type="button" class="btn btn-sm btn-primary"><span class="fe fe-edit"> </span></button></td>
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        foreach ($dataInst as $key => $value) {
                                                            ...
                                                            <tr>
                                                                <td><?php echo $key+1; ?></td>
                                                                <td><button class="btn btn-primary btn-sm" onclick='approveInst("<?php echo $value["instid"] ?>", this);'>Approve</button></td>
                                                                <td><?php echo $value['studid']; ?></td>
