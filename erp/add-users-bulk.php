                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Users Bulk Upload</h1>
                            <div>
                                <ol class="breadcrumb">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-options">
                                            <a href="./xlformats/users-bulk-format.xlsx" id='downloadFormat' class='btn btn-primary' download>Download</a>
                                        </div>
                                    </div>
                                    <form action="../assets/backend/add-users-bulk.php" method="POST" id="studForm" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body card body2" style='display: none;'>
                                            <label for=""><b>Adding Users: </b></label>
                                            <div class="progress progress-md">
                                                <div class="progress-bar bg-primary prg" style="width: 0.1%;">0.1%</div>
                                            </div>
                                            <br>
                                            <span style='text-weight:bold;display: none;' class="text-success sedone">Users From Excel are successfully added.</span>
    ...
    <script>
        document.querySelector('#studForm').addEventListener('submit', (e) => {
            ...
            if(file) {
                ...
                const worker = new Worker("uploadBulkUsersWorker.js?v=0.1");
                worker.onmessage = (ef) => {
