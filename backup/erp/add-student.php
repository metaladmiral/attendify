    ...
    <div class="page">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add New Student | Anish Kumar</h3>
                            </div>
                            <div class="card-body">
                                <div class="card-pay">
                                        ...
                                        <div class="col-6">
                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="admdate" type="date" class="form-control" placeholder="Enter email" >
                                            </div>
                                            </div>
                                            </div>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="batch" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true">
                                                    <option value="20000">₹20,000 (TwentyTthousand Rupees)</option>
                                            ...
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label class="form-label">Roll Number Statuss</label>
                                                <select name="batch" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true">
                                                    <option value="">Choose Status</option>
                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class="form-control" placeholder="Enter Last Name" >
                                            </div>
                                            </div>
                                            </div>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class="form-control" placeholder="Enter Father's Name" >
                                            </div>
                                            </div>
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Mother's Name</label>
                                                <input name="name" type="text" class="form-control" placeholder="Enter Mother's Name" >
                                            </div>
                                            </div>
                                            </div>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="date" class="form-control" placeholder="Enter Date of Birth" >
                                            </div>
                                            </div>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="number" class="form-control" placeholder="Enter Mobile Number" >
                                            </div>
                                            </div>
                                            </div>
                                            </div>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="number" class="form-control" placeholder="Enter Alternate Mobile Number" >
                                            </div>
                                            </div>
                                            </div>
                                            </div>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="number" class="form-control" placeholder="Enter WhatsApp Number" >
                                            </div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="aadharno" type="text" class="form-control" placeholder="Enter Aadhar Card / VID Number" >
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Address</label>
                                                <input name="aadharno" type="text" class="form-control" placeholder="Enter Address" >
                                            </div>
                                          ...
                                          <div class="col-6">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                             ...
                                             <a href="#tab21" data-bs-toggle="tab" class="" aria-selected="false" tabindex="-1" role="tab"><button class="btn btn-primary" onclick="">Save & Next</button></a>
                                        ...
                                        <div class="tab-pane" id="tab21" role="tabpanel">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:brown;">Total Fee: ₹20,000</span></b></button>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:green;">Total Paid: ₹5,000</span></b></button>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:red;">Fee Due: ₹5,000</span></b></button>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:blue;">Approved Installments: 2</span></b></button>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content country-select-modal">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Payments | Student Name</h6><button aria-label="Close" class="btn-close"
                    ...
                    <div class="modal-body">
                        ...
                        <input name="" type="number" class="form-control" placeholder="Due: ₹1000" >
                        </div>
                        </div>
                        <div class="col-6">
                        <div class="form-group">
                        <label class="form-label">Date</label>
                        <input name="email" type="date" class="form-control" placeholder="Date" >
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                                                ...
                                                <input id="" type="file" class="form-control" name="">
                       ...
                       <label class="form-label"> </label>
                        <button class="btn btn-info"><b>Save & Send for Verification</b></button>
        ...
        <!-- Add Payment modal END -->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Payment History &nbsp; <button class="btn btn-info"><b><i class="fa fa-file-pdf-o" aria-hidden="true"></i> &nbsp; Fee Summary</b></button></h3>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><abbr style="text-decoration: none;" title="Approved from accounts department | Approved by Anish Kumar">Approved</abbr></span></td>
                                                        <td>₹10,000</td>
                                                        <td>12 JAN 2023</td>
                                                        <td>NO</td>
                                                        <td>HDFC BANK</td>
                                                    ...
                                                    <tr>
                                                        <td>2</td>
                                                        <td><span class="badge bg-warning-transparent rounded-pill text-warning p-2 px-3"><abbr style="text-decoration: none;" title="Waiting for approval from accounts department">Waiting</abbr></span></td>
                                                        <td>₹15,000</td>
                                                        <td>12 JAN 2023</td>
                                                        <td>YES</td>
                                            ...
                                            <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><abbr style="text-decoration: none;" title="Document Uploaded by Anish Kumar">Uploaded</abbr></span></td>
                                                        <td><span class="badge bg-success-transparent rounded-pill text-success p-2 px-3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span></td>
                                                        <td>A note by Admin</td>
                                                        
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>12th Documents</td>
                                                       
                                                        <td><span class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td>
                                                        <td>NA</td>
                                                        <td>NA</td>
