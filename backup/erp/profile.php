                                    ...
                                    <div class="card-body">
                                        <div class="text-center chat-image mb-5">
                                            <div class="main-chat-msg-name">
                                                <a href="#">
                                                    <h5 class="mb-1 text-dark fw-semibold"><?php echo $_SESSION['fullname']; ?></h5>
                                                </a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $_SESSION['email']; ?>" name="email" placeholder="Email address">
                                        </div>
