                                ...
                                <form method="POST" action="../assets/backend/addBatch.php">
                                    <div class="">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label">Batch Label</label>
                                            <input name="batchLabel" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Batch Label" autocomplete="off">
                                        </div>
                                                ...
                                                <tbody>
                                                        ...
                                                        foreach ($row as $key => $value) {
                                                            ?>
                                                                ...
                                                                <button id="bDel" type="button" onclick="deleteBatch('<?php echo $value['batchid']; ?>', this);" class="btn  btn-sm btn-danger">
