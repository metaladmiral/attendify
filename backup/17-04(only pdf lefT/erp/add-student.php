    ...
    <div class="page">
                            ...
                            <div class="card-body">
                                <div class="card-pay">
                                    <ul class="tabs-menu nav" role="tablist">
                                        ...
                                        <li><a href="#tab21" data-bs-toggle="tab" onclick='' class="accountsFire" aria-selected="false" tabindex="-1" role="tab"><i class="fa fe fe-layers"></i>  Accounts</a></li>
                                ...
                                <div class="row">
                                          <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Batch <sup class="star" style='color: red;'>*</sup></label>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Counsellor <sup class="star" style='color: red;'>*</sup></label>
                                                <select name="counsellor" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true" required>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                <label class="form-label">Registration Status <sup class="star" style='color: red;'>*</sup></label>
                                                <select name="regstatus" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true" required>
                                            ...
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label class="form-label">Admission Date <sup class="star" style='color: red;'>*</sup></label>
                                                <input name="admdate" type="date" class="form-control" placeholder="Enter Admission Date" required>
                                            </div>
                                            </div>
                                            </div>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                <label class="form-label">Fee Commitment <sup class="star" style='color: red;'>*</sup></label>
                                                <!-- <select name="batch" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true">
                                                    <option value="20000">₹20,000 (Twenty Thousand Rupees)</option>
                                                </select> -->
                                                <input type="number" name="feecomm" class='form-control feecomm' value='20000' required>
                                            </div>
                                            </div>
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label class="form-label">Roll Number Status <sup class="star" style='color: red;'>*</sup></label>
                                                <select name="rollnostatus" class="form-control" data-placeholder="Choose one" tabindex="-1" aria-hidden="true" required>
                                                    <option value="" disabled selected>Choose Status</option>
                                                    <option value="0">Roll Number Received</option>
                                                    <option value="1">Pendency</option>
                                                    <option value="2">LGS Verified</option>
                                                    <option value="3">LGS Not Verified</option>
                                                    <option value="4">IBOSE</option>
                                                    <option value="4">Below 5000</option>
                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Email ID <sup class="star" style='color: red;'>*</sup></label>
                                                <input name="email" type="email" class="form-control" placeholder="Enter email" required>
                                            </div>
                                            <div class="row">
                                          <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">First Name <sup class="star" style='color: red;'>*</sup></label>
                                                <input name="firstname" type="text" class="form-control" placeholder="Enter First Name" required>
                                            </div>
                                            </div>
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Last Name <sup class="star" style='color: red;'>*</sup></label>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Father's Name <sup class="star" style='color: red;'>*</sup></label>
                                                <input name="fname" type="text" class="form-control" placeholder="Enter Father's Name"  required>
                                            </div>
                                            </div>
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Mother's Name <sup class="star" style='color: red;'>*</sup></label>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Date of Birth <sup class="star" style='color: red;'>*</sup></label>
                                            ...
                                            <div class="col-6">
                                             ...
                                             <label for="exampleInputEmail1" class="form-label">Mobile Number <sup class="star" style='color: red;'>*</sup></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="mano" type="number" class="form-control" placeholder="Enter Alternate Mobile Number">
                                            </div>
                                            </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                             ...
                                             <label for="exampleInputEmail1" class="form-label">Whatsapp Number <sup class="star" style='color: red;'>*</sup></label>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Aadhar Card Number <sup class="star" style='color: red;'>*</sup></label>
                                                <input name="aadharno" type="text" class="form-control aadharno" placeholder="Enter Aadhar Card / VID Number"  required>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">Address <sup class="star" style='color: red;'>*</sup></label>
                                          ...
                                          <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">State <sup class="star" style='color: red;'>*</sup></label>
                                            ...
                                            <div class="col-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="form-label">District <sup class="star" style='color: red;'>*</sup></label>
                                            ...
                                            <script>
                                                function sendForm(e=0) {
                                                    ...
                                                    for (let i = 0; i < 24; i++) {
                                                        ...
                                                        if(name!="uniroll" && name!="classroll" && name!="mano") {
                                                            if(val==="" || val.length==0) {
                                                                swal({
                                                                    title: "Oops!",
                                                                    text: "Operation terminated since required details were missing! Please fill all the required fields.",
                                                                    type: "warning",
                                        ...
                                        <div class="tab-pane tab21" id="" role="tabpanel">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:brown;">Total Fee: ₹<span class='ttfees'>0</span></span></b></button>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:green;">Total Paid: ₹<span class='paidfees'>0</span></span></b></button>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:red;">Fee Due: ₹<span class='leftfees'>0</span></span></b></button>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-light" disabled><b><span style="color:blue;">Approved Installments: <span class='apvdinst'>0</span></span></b></button>
                                            ...
                                            <div class="modal fade" id="country-selector">
                                                ...
                                                <div class="modal-content country-select-modal">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">Add Payments | Student Name</h6><button aria-label="Close" class="btn-close closeInstModal" data-bs-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                                                    </div>
                            ...
                            function saveSendInst() {
                                ...
                                for (let i = 0; i < 6; i++) {
                                    ...
                                    if(name=="amount") {
                                        ...
                                        let am_ = parseInt($(".ttfees")[0].innerHTML);
                                        if(am>am_) {
                                            swal({
                                                title: "Oops!",
                                ...
                                xhttp.onreadystatechange = function() {
                                    if (this.readyState == 4 && this.status == 200) {
                                        ...
                                        swal('Hooray!', 'New Student has been added successfully!', 'success');
        ...
        <!-- Add Payment modal END -->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <p>• Hover on the payment status to know more.</p>
                                        ...
                                        <div class="tab-pane tab22" id="" role="tabpanel">
                                            ...
                                            <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 1);' class="badge bg-danger-tsransparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 2);' class="badge bg-danger-tsransparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    </tr>
                                                        ...
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 3);' class="badge bg-danger-tsransparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    </tr>
                                                        ...
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 4);' class="badge bg-danger-tsransparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    </tr>
                                                        ...
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 5);' class="badge bg-danger-tsransparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    </tr>
                                                        ...
                                                        <td><span style='cursor:pointer' onclick='uploadDoc(this, 6);' class="badge bg-danger-tsransparent rounded-pill text-danger p-2 px-3">Click to Upload</span></td> 
                                                        <td>NA</td>
                                                    </tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content country-select-modal">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Dispatch </h6><button aria-label="Close" class="btn-close closeDispModal"
