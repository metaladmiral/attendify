...
if($_SESSION['lockscreen']=="1") {
    header('Location: ../login/lockscreen');
}
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <div class="main-header-center ms-3 d-none d-lg-block">
                            ...
                            <!-- <div class="dropdown-menu show" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 42px, 0px);" data-popper-placement="bottom-start"> -->
                                <!-- <button class='dropdown-item'>sd</button> -->
                            <!-- </div> -->
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown  d-flex notifications">
                                            ...
                                            <a class="nav-link icon" href="notification"><i
                                                    class="fe fe-bell"></i><span class=" pulse"></span>
                                            </a>
